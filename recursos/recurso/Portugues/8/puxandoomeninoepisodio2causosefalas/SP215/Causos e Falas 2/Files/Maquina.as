package {
	...
	public class Maquina {
		 ...
		 public static var contadorPremiosPersA:int;
		 public static var contadorPremiosPersB:int;
		 public static var contadorPremiosPersC:int;
		 public static var contadorPremiosPersD:int;
		 public static var contadorPremiosPersE:int;
	     public static var contadorPremiosPersF:int;
		 ...
		 public static var trocaCenario:Boolean;
		 ...
		 public static var indicePremios:Array = new Array();
		 public static var infoPremio:Array = new Array(30);
		 public static var premio:Array = new Array();
		 public static var originalPos:Array = new Array(30);
		 public static var comidasNoPrato:Array = new Array(30);
		 
		 public static var liberaFinal:Boolean;
