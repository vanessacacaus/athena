package {
	...
	public class Questao {
		...
		private var alternativas:Array = new Array(Maquina.numPerg);
		...
		private var feedbackTeste:Array = new Array(Maquina.numResp);
		 ...
		 */
   		private var dicaVF:Array = new Array(Maquina.numPerg);
		private var respostaCorretaVF:Array = new Array(Maquina.numPerg);
		private var feedbackVF:Array = new Array(Maquina.numPerg - 1);
		private var respostaDadaVF:Array = new Array(Maquina.numPerg);
		private var respondeuCorretamenteVF:Array = new Array(Maquina.numPerg);
		...
		public function Questao( ... args){
			...
			if(args.length > 0){
				...
				this.numAlternativas = Maquina.numPerg;
		...
		public function getStringRelatorio():String{
			...
			if(this.tipo == "teste")
			{
				ret += "Opção escolhida: " + this.alternativas[this.respostaDadaTeste] + "\n"
				ret += ((this.respondeuCorretamenteTeste) ? "CORRETA\n" : "INCORRETA\n" );
			}
			else {
