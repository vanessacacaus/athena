package{
	...
	private function defineQuestoesTeste(){
		...
		for(var i=0; i<Maquina.numPerg; i++){
			...
			for(var j=0; j<Maquina.numResp; j++){
	...
	private function defineQuestoesVF(){
		...
		// não sei se coloca Maquina.numPerg ou Maquina.numResp ou se subrai por 1
		for(i=0; i<Maquina.numResp; i++){
