package {
	...
	public class Questao {
		...
		public function verificaResposta(... args):void{
			if(this.tipo == 'teste') {
				if(this.respostaDadaTeste == this.respostaCorretaTeste)
					this.respondeuCorretamenteTeste = true;
				else
					this.respondeuCorretamenteTeste = false;
			}
			else if(this.tipo == 'vf')
				if(args.length > 0){
		...
		public function setPremio(n:String){ this.premio = n; }
